...
DEFAULT_ROWING_CONFIG: dict[str, Any] = {
    ...
    "visibility_min": 0.55,
    "catch_knee_angle_max": 125.0,
    "finish_knee_angle_min": 150.0,
    "side_view_catch_knee_angle_max": 105.0,
    "side_view_finish_knee_angle_min": 145.0,
...
DEFAULT_SKIERG_CONFIG: dict[str, Any] = {
    ...
    "visibility_min": 0.50,
    "top_wrist_above_shoulder_margin": 0.02,
    "bottom_wrist_below_chest_margin": 0.05,
    "bottom_wrist_below_shoulder_margin": 0.06,
